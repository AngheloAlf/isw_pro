...
angular.module("app", ["chart.js"]).controller("MixedChartCtrl", function ($scope, $http){
    ...
    $scope.update = function(){
        ...
        $http.get("/ticketCrud/count/week/"+annoSemana).then(function(response){
            $scope.dataSemana = [
                //response.data,
                response.data
        ...
        $http.get("/ticketCrud/count/month/"+annoMes).then(function(response){
            $scope.dataMes = [
                response.data
            ];
        ...
        $http.get("/ticketCrud/count/trimestre/"+annoTrimestre).then(function(response){
            $scope.dataTrimestre = [
                response.data
            ];
        ...
        $http.get("/ticketCrud/count/semestre/"+annoSemestre).then(function(response){
        ...
        $http.get("/ticketCrud/count/year/"+annoYear).then(function(response){
            var Data = response.data;
            $scope.dataYear = [
                Data
            ];
