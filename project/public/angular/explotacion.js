...
angular.module("app", ["chart.js"]).controller("MixedChartCtrlExplotacion", function ($scope, $http){
    ...
    $scope.update = function(){
        ...
        $http.get("/ticketCrud/count/day/"+annoDia+"/"+mesDia+"/explotacion").then(function(response){
            $scope.dataDia = [
                //response.data,
                response.data
        ...
        $http.get("/ticketCrud/count/week/"+annoSemana+"/explotacion").then(function(response){
            $scope.dataSemana = [
                //response.data,
                response.data
        ...
        $http.get("/ticketCrud/count/month/"+annoMes+"/explotacion").then(function(response){
            $scope.dataMes = [
                response.data
            ];
        ...
        $http.get("/ticketCrud/count/trimestre/"+annoTrimestre+"/explotacion").then(function(response){
            $scope.dataTrimestre = [
                response.data
            ];
        ...
        $http.get("/ticketCrud/count/semestre/"+annoSemestre+"/explotacion").then(function(response){
        ...
        $http.get("/ticketCrud/count/year/"+annoYear+"/explotacion").then(function(response){
            var Data = response.data;
            $scope.dataYear = [
                Data
            ];
