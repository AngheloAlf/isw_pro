...
angular.module("app", ["chart.js"]).controller("MixedChartCtrlWeb", function ($scope, $http){
    ...
    $scope.update = function(){
        ...
        $http.get("/ticketCrud/count/day/"+annoDia+"/"+mesDia+"/web").then(function(response){
            $scope.dataDia = [
                //response.data,
                response.data
        ...
        $http.get("/ticketCrud/count/week/"+annoSemana+"/web").then(function(response){
            $scope.dataSemana = [
                //response.data,
                response.data
        ...
        $http.get("/ticketCrud/count/month/"+annoMes+"/web").then(function(response){
            $scope.dataMes = [
                response.data
            ];
        ...
        $http.get("/ticketCrud/count/trimestre/"+annoTrimestre+"/web").then(function(response){
            $scope.dataTrimestre = [
                response.data
            ];
        ...
        $http.get("/ticketCrud/count/semestre/"+annoSemestre+"/web").then(function(response){
        ...
        $http.get("/ticketCrud/count/year/"+annoYear+"/web").then(function(response){
            var Data = response.data;
            $scope.dataYear = [
                Data
            ];
