...
angular.module("app", ["chart.js"]).controller("MixedChartCtrlExposicion", function ($scope, $http){
    ...
    $scope.update = function(){
        ...
        $http.get("/ticketCrud/count/day/"+annoDia+"/"+mesDia+"/exposicion").then(function(response){
            $scope.dataDia = [
                //response.data,
                response.data
        ...
        $http.get("/ticketCrud/count/week/"+annoSemana+"/exposicion").then(function(response){
            $scope.dataSemana = [
                //response.data,
                response.data
        ...
        $http.get("/ticketCrud/count/month/"+annoMes+"/exposicion").then(function(response){
            $scope.dataMes = [
                response.data
            ];
        ...
        $http.get("/ticketCrud/count/trimestre/"+annoTrimestre+"/exposicion").then(function(response){
            $scope.dataTrimestre = [
                response.data
            ];
        ...
        $http.get("/ticketCrud/count/semestre/"+annoSemestre+"/exposicion").then(function(response){
        ...
        $http.get("/ticketCrud/count/year/"+annoYear+"/exposicion").then(function(response){
            var Data = response.data;
            $scope.dataYear = [
                Data
            ];
